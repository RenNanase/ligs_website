...
export default function AdminBahagianEditPage() {
  ...
  const [form, setForm] = useState<BahagianForm>({
    name: "",
    slug: "",
    shortDescription: "",
    content: "<p></p>",
    ...
    fetch(`/api/bahagian/${id}`)
      ...
      .then((data) => {
        setForm({
          ...
          membersImage: data.membersImage || "",
      ...
      .catch(() => toast.error("Failed to load bahagian"))
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success("Bahagian updated successfully")
  ...
  return (
    <AdminLayout>
      <div className="mb-6 flex items-center gap-4">
        ...
        <h1 className="font-heading text-2xl font-bold text-foreground">Edit Bahagian</h1>
      </div>
      ...
      <form onSubmit={handleSubmit} className="grid gap-6 lg:grid-cols-3">
        <div className="space-y-6 lg:col-span-2">
          ...
          <div className="flex gap-3">
            <Button type="submit" disabled={saving} className="gap-2 bg-primary text-primary-foreground hover:bg-accent hover:text-accent-foreground">
